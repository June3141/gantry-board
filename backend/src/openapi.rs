...
#[openapi(
    paths(
        ...
        handlers::invitations::delete_invitation,
        handlers::invitations::get_invitation_by_token,
        ...
        handlers::worktrees::list_project_worktrees,
        handlers::worktrees::create_project_worktree,
        handlers::worktrees::get_project_worktree,
        handlers::worktrees::delete_project_worktree,
    ...
    components(schemas(
        ...
        models::project_invitation::ProjectInvitation,
        models::project_invitation::CreateInvitationRequest,
        models::project_invitation::CreateInvitationResponse,
        models::project_invitation::InvitationInfo,
    ...
    tags(
        ...
        (name = "invitations", description = "Project invitation management"),
